...
@WebServlet(value = "/cwe-425/BenchmarkTestCWE425_02/*")
public class BenchmarkTestCWE425_02 extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final String ADMIN_SESSION = "BenchmarkTestCWE425_02.admin";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = request.getParameter("BenchmarkTestCWE425_02_user");
        String password = request.getParameter("BenchmarkTestCWE425_02_pass");
        ...
        response.sendRedirect(
                request.getContextPath() + "/cwe-425/BenchmarkTestCWE425_02/admin/exports");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/admin/exports".equals(controllerPath)) {
            ...
            writeExportPage(response, "Authenticated export controller");
        } else if ("/legacy/admin/export".equals(controllerPath)) {
            // CWE-425: a retired export route remains mapped without the authentication guard.
            writeExportPage(response, "Legacy export controller");
        } else {
            response.sendError(HttpServletResponse.SC_NOT_FOUND);
        }
    }
    ...
    private static void writeExportPage(HttpServletResponse response, String route)
            throws IOException {
